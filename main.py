...
import games.wrapped_flappy_bird as game
import random
import numpy as np
...
GAME = 'bird' # the name of the games being played for log files
...
if __name__ == '__main__': 
    ...
    flappyBird = game.GameState() # Step 3: play games
    ...
    print(brain.currentState.shape) # Step 3.2: run the games
